...
export const getStaticChange24h = (symbol: string): number => {
  switch (symbol.toUpperCase()) {
    case "PI": return 1.45;
...
export const getStaticMarketCap = (symbol: string): number => {
  switch (symbol.toUpperCase()) {
    case "PI": return 0;
...
export const getStaticVolume24h = (symbol: string): number => {
  switch (symbol.toUpperCase()) {
