const STATIC_COIN_DESC: { [key: string]: { EN: string; RU: string; ZH: string; FR: string; AR: string; HI: string; ES: string } } = {
  ...
  HBAR: {
    ...
    AR: "هيديра (Hedera) هي شبكة فريدة من الفئة المؤسсية تعتمد на تقنية هاش غراف (Hashgraph). وتتميز بسرعة معالجة فائقة ونموذج تنسيق لا مركزي موثوق.",
  ...
  ZYPTO: {
    ...
    FR: "Zypto is une infrastructure de paiement moderne proposant des cartes crypto personnalisées, des portefeuilles décentralisés et des solutions de passerelle de vente.",
  ...
  TON: {
    ...
    AR: "ذا أوبн نيتورك (TON) هو بلوكشين متطور مدمج في تيليجرام. ويسهل عمليات التحويل الفورية والمنخفضة التكلفة وتشغيل البوتات التطبيقية.",
    HI: "The Open Network (TON) एक अत्यधिक कुशल ब्लॉकचेн है जो टेलीग्राम के साथ एकीकृत है। यह त्वरित हस्तांतरण और विभिन्न अनुप्रयोगों को चलाने की अनुमति देता है।",
