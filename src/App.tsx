...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 text-slate-800 dark:bg-zinc-950 dark:text-zinc-100 transition-colors duration-300 flex flex-col font-sans">
      ...
      {/* Footer Banner */}
      <footer className="w-full border-t border-slate-100 py-6 text-center text-xs text-slate-400 dark:border-zinc-900 dark:text-zinc-505 bg-white dark:bg-zinc-950 mt-10 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3 font-sans">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="font-bold text-slate-600 dark:text-zinc-400 font-sans">KASPI Proxy</span>
          </div>
        </div>
      </footer>
